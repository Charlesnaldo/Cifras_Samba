...
export const MUSICAS: Musica[] = [
  {
    ...
    youtubeUrl: 'https://www.youtube.com/watch?v=09_s_Kh8sls',
    ritmo: 'Samba de Raiz',
    tom: 'F',
    dificuldade: 'Media',
...
(Repete Tudo)`
  },
  {
    ...
    youtubeUrl: 'https://www.youtube.com/watch?v=soN4mN0hR4Q',
    ritmo: 'Samba de Raiz',
    tom: 'C',
    dificuldade: 'Facil',
...
`
  },
  {
    ...
    youtubeUrl: 'https://www.youtube.com/watch?v=_n3D8Qh4G1Q',
    ritmo: 'Samba de Raiz',
    tom: 'Dm',
    dificuldade: 'Facil',
    slug: 'iracema',
