    ...
    <Link href={`/musica/${slug}`} className="group block">
      <div className="bg-zinc-900/40 backdrop-blur-sm border border-white/[0.05] p-6 rounded-[2.5rem] hover:bg-zinc-900/60 hover:border-emerald-500/30 transition-all duration-500">
        ...
        <div className="space-y-1">
          <h3 className="text-xl font-black text-foreground uppercase italic tracking-tighter leading-tight group-hover:text-emerald-500 transition-colors">
            {titulo}
          </h3>
        ...
        <div className="mt-8 pt-5 border-t border-white/[0.05] flex items-center justify-between">
          <div className="flex gap-6">
            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest mb-0.5">Tom</span>
              <span className="text-sm font-mono font-bold text-zinc-300 group-hover:text-emerald-400 transition-colors">{tom}</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest mb-0.5">Ritmo</span>
              <span className="text-sm font-bold text-zinc-300">{ritmo}</span>
            </div>
          </div>
