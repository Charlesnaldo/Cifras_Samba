      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            <h1 className="text-6xl font-black text-white uppercase italic tracking-tighter">
              Chord<span className="text-accent">Lib</span>
            </h1>
          ...
          <div className="flex bg-zinc-900 p-1 rounded-2xl border border-white/5">
            <button
              ...
              className={`px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${instrumento === 'cavaquinho' ? 'bg-accent text-black shadow-[0_0_20px_rgba(16,185,129,0.4)]' : 'text-zinc-500 hover:text-white'}`}
            >
              Cavaquinho
            </button>
            <button
              onClick={() => setInstrumento('violao')}
              className={`px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${instrumento === 'violao' ? 'bg-accent text-black shadow-[0_0_20px_rgba(16,185,129,0.4)]' : 'text-zinc-500 hover:text-white'}`}
            >
              Violao
            </button>
          </div>
        ...
        <div className="relative group max-w-xl">
          ...
          <input
            ...
            className="w-full bg-zinc-900/50 border border-white/5 p-5 pl-14 rounded-2xl text-white outline-none focus:border-accent/50 transition-all shadow-2xl"
